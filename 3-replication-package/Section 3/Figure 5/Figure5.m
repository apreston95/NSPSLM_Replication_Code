...
dynare NSPSLM_CM_Wage_Rigid noclearall
...
load('IRF_HET.mat')
load('IRFs_CM_RIGID.mat')
load('IRFs_SPOT_HET.mat')
...
subplot(1,2,1)
plot(0:H,IRF_OUTPUT_NEWS4_HET(1:end)*100,'color','black','LineWidth',2);
hold on
plot(0:H,IRF_OUTPUT_NEWS4_CM_RIGID(1:end)*100,'color','blue','LineWidth',2,'LineStyle','--');
hold on
plot(0:H,IRF_OUTPUT_NEWS4_SPOT_HET(1:end)*100,'color','red','LineWidth',2,'LineStyle','-.');
hold on
...
subplot(1,2,2)
plot(0:H,IRF_NOMINAL_NEWS4_HET(1:end)*100,'color','black','LineWidth',2);
hold on
plot(0:H,IRF_NOMINAL_NEWS4_CM_RIGID(1:end)*100,'color','blue','LineWidth',2,'LineStyle','--');
hold on
plot(0:H,IRF_NOMINAL_NEWS4_SPOT_HET(1:end)*100,'color','red','LineWidth',2,'LineStyle','-.');
hold on
line([0 H],[0 0],'color','black','LineStyle','-');
ylabel('\% Deviation','interpreter','LaTeX');
xlabel('Quarters','interpreter','LaTeX');
