...
Var W R Pi Eta b Y A N M Eta_V MC U UN V JC C C_UU C_E_0 B_E_0 Psi_E_0 Ave_Cons_Loss logY logA logEta a1 a2 SavingRate URisk
...
IRF_TFP_NEWS4 = oo_.irfs.logA_Eps_N;
IRF_OUTPUT_NEWS4 = oo_.irfs.logY_Eps_N;
IRF_UNEMPLOYMENT_NEWS4 = oo_.irfs.UN_Eps_N;
IRF_VACANCIES_NEWS4 = oo_.irfs.V_Eps_N;
IRF_NOMINAL_NEWS4 = oo_.irfs.R_Eps_N;
IRF_INFLATION_NEWS4 = oo_.irfs.Pi_Eps_N;
IRF_SAVING_NEWS4 = oo_.irfs.SavingRate_Eps_N;
IRF_URISK_NEWS4 = oo_.irfs.URisk_Eps_N;
IRF_CONS_NEWS4 = oo_.irfs.C_Eps_N;
IRF_JF_NEWS4 = oo_.irfs.logEta_Eps_N;
